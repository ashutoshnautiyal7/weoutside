...
const Topbar = ({user,onSearch}) => {
  ...
  return (
    <div className="flex items-center justify-center gap-8 py-5 w-5/6">
      <div className="w-[50%] flex gap-2 justify-center md:gap-5 items-center ">
        {/* <Link href="/" className="relative w-[50px] h-[40px] md:w-[120px] md:h-[100px]">
          <Image alt="image" fill={true} src={"/image5.png"}></Image>
        </Link> */}
        <div className="bg-white flex gap-1 h-fit w-full justify-center items-center py-1 md:py-2 px-2 md:px-5 rounded-xl">
      ...
      <div className="w-full md:w-[25%] justify-start gap-2 md:gap-6">

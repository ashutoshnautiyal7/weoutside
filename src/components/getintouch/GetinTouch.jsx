...
const GetinTouch = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className='bg-[#F5F5F5] py-5 md:py-10 w-full md:w-9/12 mx-auto p-2 md:p-5'>
        <h2 className='text-[#D21414] text-center text-3xl md:text-5xl font-semibold pb-5'>Get in touch</h2>
        <div className='flex flex-col gap-5 w-full md:w-9/12 mx-auto text-black text-sm'>
            ...
            <button type='submit' className='bg-gradient-to-b from-[#FF1010] to-[#692323] rounded-sm text-white p-3 w-[200px]'>Send Message</button>
        </div>
    </form>
  )
}

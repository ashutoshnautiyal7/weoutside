...
const Fundraise = () => {
  return (
    <div className='flex flex-col gap-8 w-full md:w-5/6 mx-auto py-10'>
        <div className='w-full p-3 md:p-5 bg-gradient-to-l from-[#BD1616] via-[#000000] to-[#000000]'>
            <div className='flex gap-1 md:w-11/12 mx-auto'>
                <div className='w-1/2 flex flex-col gap-5 items-start'>
                    ...
                    <button className='bg-[#D93737] text-xs md:text-xl font-medium py-2 md:py-4 px-2 md:px-8 rounded-tr-full flex justify-center items-center gap-1 md:gap-2'>LETS JOIN
                ...
                <div className='w-1/2 flex justify-end'>
                    <div className='relative h-[250px] w-[250px] md:h-[500px] md:w-[500px]'>
                        <Image fill={true} src={"/fundraise.png"}></Image>
                    </div>
                </div>
            </div>
        </div>
        <div className='w-full p-3 md:p-5 bg-gradient-to-r from-[#BD1616] via-[#000000] to-[#000000]'>
            <div className='flex gap-1 md:w-11/12 mx-auto'>
                <div className='w-1/2 flex'>
                    <div className='relative h-[250px] w-[250px] md:h-[500px] md:w-[500px]'>
                        <Image fill={true} src={"/comm.png"}></Image>
                    </div>
                </div>
                <div className='w-1/2 flex flex-col gap-5 items-end'>
                    ...
                    <button className='bg-[#D93737] text-xs md:text-xl font-medium py-2 md:py-4 px-2 md:px-8 rounded-tl-full flex justify-center items-center gap-1 md:gap-2'>
                    <div className='relative h-[10px] w-[15px] md:h-[25px] md:w-[35px]'>
                        <Image fill={true} src={"/leftarrow.png"}></Image>
                    </div>
                    LETS CONNECT
                    </button>
                </div>
        ...
        <div className='w-full p-3 md:p-5 bg-gradient-to-l from-[#BD1616] via-[#000000] to-[#000000]'>
            <div className='flex gap-1 md:w-11/12 mx-auto'>
                ...
                <div className='w-1/2 flex justify-end'>
                    <div className='relative h-[250px] w-[250px] md:h-[500px] md:w-[500px]'>
                        <Image fill={true} src={"/showcase.png"}></Image>
                    </div>
                </div>
            </div>
        </div>
